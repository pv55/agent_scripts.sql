...
(SELECT
(case when s.city = 'МСК-Шараев' then 'Сергей Шараев' else f4.name_agent end) name_agent,
(case when s.city = 'МСК-Шараев' then '900' else f4.utm_content end) utm_content,
s.*,

...
where 1=1
and f1.fleet_gk in ( 200017820,200017819, 200017818,200017816, 200017817,200017815, 200017083, 200017177,200017412,200017342,200017205,200017203, 200017524,200017523,200017517,200017430,200017548,200017550,200017739,200017738,200023811 )
...
count(distinct(case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) then (case when f2.order_date_key between a.ftp_date_key_park and a.FTR_plus_30days then f2.order_gk end)
...
count(distinct(case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) then f2.order_gk
...
count(distinct (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560)  and f2.order_date_key between a.ftp_date_key_park and a.ftp_date_key_park + interval '6' day then f2.order_gk
    end)) rides_7_days,
...
cast(sum (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park and a.ftp_date_key_park + interval '6' day then f2.cost_inc_vat
...
count(distinct (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '7' day and a.ftp_date_key_park + interval '13' day then f2.order_gk
    end)) rides_8_to_14_days,

cast(sum (case
    when f2.fleet_gk in (200017820,200017819, 200017818,200017816, 200017817,200017815, 200017083, 200017177,200017412,200017342,200017205,200017203, 200017524,200017523,200017517,200017430,200017548,200017550,200017739,200017738) and f2.order_date_key between a.ftp_date_key_park + interval '7' day and a.ftp_date_key_park + interval '13' day then f2.cost_inc_vat
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '7' day and a.ftp_date_key_park + interval '13' day then f2.cost_inc_vat
...
count(distinct (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '14' day and a.ftp_date_key_park + interval '20' day then f2.order_gk
...
cast(sum (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '14' day and a.ftp_date_key_park + interval '20' day then f2.cost_inc_vat
...
count(distinct (case
    ...
    when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '21' day and a.ftp_date_key_park + interval '29' day then f2.order_gk
    ...
    cast(sum (case
        ...
        when f2.fleet_gk = 200023811 and f2.origin_osm_location_key in (498,502,505,510,512,523,560) and f2.order_date_key between a.ftp_date_key_park + interval '21' day and a.ftp_date_key_park + interval '29' day then f2.cost_inc_vat
...
(case
    ...
    when a.city in('МО-Лайттакси','Казань-Дептакси','Спб-Дептакси','Казань-Лайттакси','Спб-Лайттакси','НН-Лайттакси','РНД-Лайттакси','Влг-Лайттакси','СРТ-Лайттакси','Влг-Шараев','СРТ-Шараев','НН-Шараев','РНД-Шараев','Казань-Шараев','Спб-Шараев' ) and a.ftp_date_key_park  >= date '2021-03-29' then 5
    end) as type_bonus
